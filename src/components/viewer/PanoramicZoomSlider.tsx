...
export const PanoramicZoomSlider: React.FC<PanoramicZoomSliderProps> = ({
  ...
  return (
    ...
    >
      ...
      <Slider
        className="w-[140px] [&_[data-slot=slider-track]]:bg-gray-600 [&_[data-slot=slider-range]]:bg-white"
        value={[zoomLevel]}
        min={0}
        max={maxFov - minFov}
        step={1}
      ...
      <Button
        className="min-w-16 tabular-nums h-8 text-white hover:bg-white/10"
        variant="ghost"
