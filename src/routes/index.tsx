          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="w-10 h-10 bg-gray-800/90 border-2 border-gray-600 rounded-lg flex items-center justify-center hover:bg-gray-700/90 text-white transition-colors"
                aria-label="Open map"
              >
